...
The "standard" source file `events.hepmc3` contains 100 13TeV pp events, generated by Pythia. Please see the [JetReconstructionBenchmarks.jl](https://github.com/graeme-a-stewart/JetReconstructionBenchmarks.jl) repository for different event input files, with different initial particle densities.
